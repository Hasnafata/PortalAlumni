...
<style>
    /* Styling estetik sesuai versi admin */
            ...
            <div class="card-body p-4">
                ...
                <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-bold small">NIM (Tidak dapat diubah)</label>
                            <input type="text" class="form-control bg-light" value="{{ $user->nim }}" readonly>
                            <small class="text-muted" style="font-size: 0.75rem;">Hubungi admin jika ada kesalahan NIM.</small>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="pekerjaan" class="form-control shadow-sm" style="border-radius: 10px;" value="{{ old('pekerjaan', $user->pekerjaan) }}" placeholder="Contoh: Software Engineer">
                    </div>
